        ...
        <div>
          <Card border="light" className="table-wrapper table-responsive shadow-sm">
            <Card.Body className="pt-0">
              <Table hover className="user-table align-items-center" responsive="sm">
                <thead>
                  <tr>
                    <th className="border-bottom">STT</th>
                    <th className="border-bottom">Trạng thái</th>
                    <th className="border-bottom">Thời gian</th>
                    <th className="border-bottom text-center">Mục tiêu</th>
...
export const WorkerKPITable = () => {
  ...
  const TableRow = (props) => {
    const { invoiceNumber, issueDate, status, name, targetNumber,score } = props;
    const statusVariant = status === "Đã kích hoạt" ? "success":"warning";
    return (
      <tr>
        <td>
            ...
            <Table hover className="user-table align-items-center" responsive="sm">
              <thead>
                <tr>
                  <th className="border-bottom">STT</th>
                  <th className="border-bottom">Trạng thái</th>
                  <th className="border-bottom">Công nhân</th>
                  <th className="border-bottom text-center">Mục tiêu</th>
                  <th className="border-bottom text-center">Điểm số</th>
                  <th className="border-bottom text-center">Hành động</th>
                </tr>
